...
public class MembershipRecord extends UpdatableRecordImpl<MembershipRecord> implements Record8<Integer, Integer, Boolean, Integer, Integer, Date, String, OffsetDateTime> {

    private static final long serialVersionUID = 1531073754;
     ...
     */
    @Override
    public Row8<Integer, Integer, Boolean, Integer, Integer, Date, String, OffsetDateTime> fieldsRow() {
     ...
     */
    @Override
    public Row8<Integer, Integer, Boolean, Integer, Integer, Date, String, OffsetDateTime> valuesRow() {
     ...
     */
    @Override
    public MembershipRecord values(Integer value1, Integer value2, Boolean value3, Integer value4, Integer value5, Date value6, String value7, OffsetDateTime value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MembershipRecord(Integer id, Integer originalId, Boolean active, Integer personId, Integer membershipTypeId, Date paymentDate, String createdBy, OffsetDateTime createdDate) {
        super(Membership.MEMBERSHIP);
