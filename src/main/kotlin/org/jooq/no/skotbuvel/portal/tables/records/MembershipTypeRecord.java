...
public class MembershipTypeRecord extends UpdatableRecordImpl<MembershipTypeRecord> implements Record9<Integer, Boolean, String, Integer, Integer, String, OffsetDateTime, String, OffsetDateTime> {

    private static final long serialVersionUID = 1784358375;
     ...
     */
    @Override
    public Row9<Integer, Boolean, String, Integer, Integer, String, OffsetDateTime, String, OffsetDateTime> fieldsRow() {
     ...
     */
    @Override
    public Row9<Integer, Boolean, String, Integer, Integer, String, OffsetDateTime, String, OffsetDateTime> valuesRow() {
     ...
     */
    @Override
    public MembershipTypeRecord values(Integer value1, Boolean value2, String value3, Integer value4, Integer value5, String value6, OffsetDateTime value7, String value8, OffsetDateTime value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public MembershipTypeRecord(Integer id, Boolean active, String type, Integer year, Integer price, String createdBy, OffsetDateTime createdDate, String deletedBy, OffsetDateTime deletedDate) {
        super(MembershipType.MEMBERSHIP_TYPE);
